      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-600 text-sm max-w-xs leading-relaxed mx-auto md:mx-0">
              Discover ethnically cultivated and Fair-Trade gifts from artisans worldwide. 
              Fashion that follows conscience.
            </p>
            <div className="flex space-x-11 pt-5 justify-center md:justify-start">
              {/* Facebook Icon */}
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-2 items-center md:items-start">
              <input
                ...
                className="px-4 py-2.5 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 flex-grow text-gray-900 placeholder-gray-500 shadow-sm w-full sm:w-auto"
              />
              <button className="bg-orange-500 hover:bg-orange-500 text-gray-900 px-4 py-2.5 rounded-lg font-medium transition-all duration-300 whitespace-nowrap transform hover:scale-[1.02] active:scale-[0.98] shadow-md">
                Subscribe
              </button>
            </div>
          </div>
